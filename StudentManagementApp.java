...
public class StudentManagementApp extends Application {
    ...
    "jdbc:mysql://127.0.0.1:3306/studentdb?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC",
    "root",
    "NewRoot@12345"
);
    ...
    private void readStudents() {
        ...
        try (
            ...
            displayArea.setText("Error reading student records.");
            e.printStackTrace();
        }
    }
    ...
    private void updateStudent() {
        ...
        try {
            ...
            displayArea.setText("Please enter valid ID and age.");
